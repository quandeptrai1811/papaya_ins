# 🍍 Papaya Insurance — AI Engineering Challenges Suite

Welcome to the **Papaya Insurance AI Engineering Challenges** repository. This folder aggregates solutions for a series of advanced engineering and data challenges aimed at building high-performance, robust, and beautifully designed insurance technology components.

Each challenge has been fully solved, strictly adheres to all specified business rules, and is optimized for both speed and premium user experience (UX).
...
| **02** | [**Claims Data Cleanup**](#2-claims-data-cleanup--report) <br> Dependency-free Python ETL script cleaning messy claims. | Python 3 (Pure - zero libraries) | *N/A (CLI Tool)* | [Source Folder](https://github.com/quandeptrai1811/papaya_ins/tree/main/AI_Engineering_Challenges/AI_Challenge_02) | ✅ Completed |
...
| **06** | [**Policy Benefits Calculator**](#6-policy-benefits-calculator) <br> Chronological benefits engine with complex deductibles. | Node.js, TypeScript, Jest | *N/A (Engine/Library)* | [Source Folder](https://github.com/quandeptrai1811/papaya_ins/tree/main/AI_Engineering_Challenges/AI_Challenge_06) | ✅ Completed |
...
| **10** | [**Fraud Detection Engine**](#10-fraud-detection-scoring-engine) <br> Multi-pass fraud analyzer executing 8 mathematical rules. | Node.js, TypeScript, Jest | *N/A (Engine/Library)* | [Source Folder](https://github.com/quandeptrai1811/papaya_ins/tree/main/AI_Engineering_Challenges/AI_Challenge_10) | ✅ Completed |
